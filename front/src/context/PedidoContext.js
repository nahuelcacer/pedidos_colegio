  ...
  switch (action.type) {
    ...
    case "delete item edit":
      return {
        ...
        editPedido: {
          ...state.editPedido,
          items: state.editPedido.items.filter(
    ...
    case "select customer edit":
      return {
        ...state,
        editPedido: { ...state.editPedido, cliente: action.payload },
      };
          ...
          items: state.editPedido.items.map((item, idx) =>
            idx === action.payload.index
              ? {
                  ...
                  total_item: action.payload.cantidad * item.producto.precio,
                }
              : item
          ),
        },
...
export const PedidoProvider = ({ children }) => {
  ...
  return (
    <PedidoContext.Provider
      value={{ state, dispatch, pedidos, updatePedidos, handleSearch }}
    >
      {children}
    </PedidoContext.Provider>
  );
